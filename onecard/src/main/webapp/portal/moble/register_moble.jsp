...
$(function(){
			...
			/* alert("ua.match为：----"+ua.match(/KHTML/i));
			alert("appVersion为：----"+appVersion); */
	...
	<!-- <div class="container"> -->
		<div class="content">
			...
			<form action="/onecard/portal/regresult" method="post">
				...
				<p>
					<span class="agree"><input
						type="checkbox" /><a href="./agreement.jsp" target="_blank"><span>同意协议(<%=res.getString("LibName")%>在线实名注册使用协议)</span></a></span><input type="submit" class="regBtn" value="注册" onclick="subReg();return false;"><!-- &emsp;<input
						type="reset" value="重置" /> -->
				</p>
			</form>
		</div>
