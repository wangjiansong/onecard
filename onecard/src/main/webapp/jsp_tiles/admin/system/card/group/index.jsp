...
<script type="text/javascript">
				...
				$.ajax({
					...
					success : function(backData){
						if (backData == 1) {
							...
							setTimeout(function(){
								window.location.href = "${base_url}/group/index";
							},1000);
							return false;
						} else {
							info.innerHTML = "删除失败！";
	...
	function member(groupId) {
		document.location.href = "member/"+groupId;
	}
</script>
<div class="bs-docs-example">
	<ul class="nav nav-tabs">
		<li><a href="${base_url}/consumption/rule">刷卡消费管理</a></li>
		<li class="active"><a href="${base_url}/group/index">分组管理</a></li>
	</ul>
</div>
<div id="info"></div>
<div>
