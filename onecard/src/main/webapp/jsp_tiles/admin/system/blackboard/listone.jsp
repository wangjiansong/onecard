...
<section id="tabs">
	<div>
		<ul id="myTab" class="nav nav-tabs">
			<li class="active"><a href="#" data-toggle="tab">公告详情</a></li>
		</ul>
	...
	<form action="list" id="form1" method="POST" class="form-inline" >
		<div class="well form-actions_1">
			...
			<div class="control-group" >
				<span style="font-weight:bold;">标题：</span>${blackboard.title }
			</div>
			<div class="control-group" >	
				<span style="font-weight:bold;">内容：</span>${blackboard.content }
			</div>
		</div>
	</form>
</fieldset>
