...
<script type="text/javascript">
	...
	function checkForm() {
		...
		$.ajax({
			type : "POST",
			url : "<c:url value='/system/reader/readertype/checkReaderType' />",
			...
			success : function(backData){
				if(backData > 0){
					...
					var params = {readerType : readerType,libCode : libCode,sign : sign, 
						libSign : libSign, descripe: descripe,
						valdate: valdate, checkfee:checkfee, idfee:idfee, 
						servicefee:servicefee, deposity:deposity};
					$.ajax({
						type : "POST",
						url : "<c:url value='/system/reader/readertype/addReaderType' />",
						data : params,
						dataType : "text",
						success : function(backData){
							if(backData > 0){
...
<section id="tabs">
	<div>
		<ul id="myTab" class="nav nav-tabs">
			<li class="active"><a href="#" data-toggle="tab">读者流通类型 >> 新增</a></li>
		</ul>
	...
	<div class="span6">
		<div class="control-group">
			...
			<div class="controls" style="width:200px;">
				<input type="text" id="readerType" name="readerType" class="input-medium" />
		...
		<div class="control-group">
			...
			<div class="controls" style="width:200px;">
				<input type="text" id="descripe" name="descripe" class="input-medium" />
				<font class="label-required"></font>
			</div>
		</div>
		<div class="control-group">
	...
	<div class="span6">
		<div class="control-group">
			...
			<div class="controls" style="width:300px;">
				...
				<font class="" style="color:red;">（天数）</font>
			</div>
		</div>
		<div class="control-group">
