...
function exportExcel(){
	...
	form1.action = "<c:url value='/admin/sys/cirfinlog/exportPersonalListExcel' />";
	form1.submit();
...
<fieldset>
	...
	<c:if test="${!empty message}">
		...
		<form action="personalList" id="form1" method="POST" class="form-inline">
		<div class="row-fluid">
			<div class="span3">
...
<c:set var="pager_base_url">${BASE_URL}/personalList?</c:set>
