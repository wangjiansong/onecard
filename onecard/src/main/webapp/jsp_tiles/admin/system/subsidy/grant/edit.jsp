...
<script type="text/javascript">
	$(document).ready(function(){
		$("#isAutoGrant").val("${grant.isAutoGrant}");
		var dates = eval('${dateList}');
		var size = dates.length;
		if (size > 4) {
			$("#grantDate")[0].size = size;
		}
		for (var i=0; i<size; i++) {
			$("#grantDate")[0].options.add(new Option(dates[i],dates[i]));
			//document.getElementById("grantDate").add(new Option(dates[i],dates[i]));
		}
		$("#grantDate")[0][size-1].selected = true;
		//document.getElementById("grantDate")[size-1].selected = true;
	});
</script>
<ul class="breadcrumb">
	<li><a href="${base_url}/grant">补助发放</a><span class="divider">/</span></li>
	<li class="active">修改补助发放</li>
</ul>
<div id="info"></div>
<form class="form-horizontal" action="#" method="post">
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="grantTitle" value="${grant.grantTitle}" maxlength="32" />
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="grantAmount" value="${grant.grantAmount}" onkeyup="javascript: clearNoNum(this);" onblur="javascript: checkNum(this);" maxlength="12" />
			<font class="label-required"></font>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea rows="4" id="remark">${grant.remark}</textarea>
		</div>
	</div>
	<div class="control-group">
		<div class="controls">
