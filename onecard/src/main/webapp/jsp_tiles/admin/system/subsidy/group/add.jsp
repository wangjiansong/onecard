...
<c:set var="add_url">
	<c:url value="/admin/subsidy/group/add" />
</c:set>
...
<script type="text/javascript">
	...
	function addGroup(submitButton) {
		...
		$.ajax({
			type : "POST",
			url : "${add_url}",
			data : {groupName: groupName,remark: remark},
			dataType : "text",
...
<div class="navbar">
	<div class="navbar-inner">
		<a class="brand" href="javascript:void(0);">新增分组</a>
	</div>
</div>
<form class="form-horizontal" action="">
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="groupName" maxlength="32" />
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="remark">备注：</label>
		<div class="controls">
			<textarea rows="3" id="remark" maxlength="128"></textarea>
		</div>
	</div>
	<div class="control-group">
		<div class="controls">
			<button type="button" class="btn btn-primary" onclick="javascript:addGroup(this);">保存</button>
