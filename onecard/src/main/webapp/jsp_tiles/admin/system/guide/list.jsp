...
<section id="tabs">
	<div>
		<ul id="myTab" class="nav nav-tabs">
			<li class="active"><a href="#" data-toggle="tab">办事指南管理</a></li>
		</ul>
...
<fieldset>
	...
	<div class="well form-actions_1">
			...
			<a class="btn btn-success" href="${BASE_URL}/add"><i class="icon-plus icon-white"></i>新增办事指南</a>
			</div>
	</div>
	</form>
</fieldset>
