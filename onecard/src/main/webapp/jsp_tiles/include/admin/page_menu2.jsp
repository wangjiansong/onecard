...
<div class="well sidebar-nav">
	<ul class="nav nav-list">
		...
		<li class="submenuItem <c:if test="${ACTIVE_MENU eq 'approve_index'}" >active</c:if>">
		...
		<li class="divider"></li>
		<li class="nav-header" id="cirfin"><i class="icon-calendar"></i>结算中心</li>
		...
		<li class="submenuItem <c:if test="${ACTIVE_MENU eq 'cirfinlogList'}">active</c:if>">
			<shiro:hasPermission name="cirfin:cirfinlogList">
				<a target="_blank" href="<c:url value='/cirfinloglist/list' />">财经明细列表</a>
			</shiro:hasPermission>
		</li>
		...
		<li class="divider"></li>
		<li class="nav-header" id="rights"><i class="icon-eye-open"></i>授权管理</li>
		...
		<li class="divider"></li>
		<li class="nav-header" id="library"><i class="icon-globe"></i>系统组织管理</li>
		...
		<li class="divider"></li>
		<li class="nav-header" id="library"><i class="icon-globe"></i>系统日志</li>
		...
		<li class="submenuItem <c:if test="${ACTIVE_MENU eq 'logcir_syncFailurelist'}">active</c:if>">
			<shiro:hasPermission name="logcir:syncFailurelist">
				<a href="<c:url value='/admin/sys/logcir/syncFailurelist' />">同步失败日志</a>
			</shiro:hasPermission>
		</li>
		
		<li class="divider"></li>
		<li class="submenuItem">
			<a href="#"><i class="icon-flag"></i>帮助</a>
		</li>
	</ul>
</div>