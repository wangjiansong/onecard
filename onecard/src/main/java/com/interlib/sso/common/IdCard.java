...
public class IdCard {
     ...
     * @return 生日(yymmdd)
     */
    public static String getYearLastByIdCard(String idCard) {
        return idCard.substring(8, 14);
    }
    /**
     * 根据身份编号获取生日年
     *
...
//修改年龄的方法
 /*   @RequestMapping(value = "shebaoshuju",method = RequestMethod.GET)
    ...
    public static void main(String [] a){
        ...
        String nianhouliangwei= getYearLastByIdCard(idcard);
        Short nian=getYearByIdCard(idcard);
        Short yue=getMonthByIdCard(idcard);
        Short ri=getDateByIdCard(idcard);
        System.out.print(nian+"年"+yue+"月"+ri+"日"+nianhouliangwei+"年后两位");
